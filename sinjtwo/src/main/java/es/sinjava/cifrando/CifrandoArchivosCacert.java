...
public class CifrandoArchivosCacert {
	...
	public static void main(String[] args) throws Exception {
		...
		String alias = "sinjavalbs";
		String password = "changeit";

		byte[] cifrados = cifrador.encriptCacert(alias, password.toCharArray(), textIn.getBytes());
		...
		// Se desencripta
		byte[] bytesDesencriptados = cifrador.deEncriptCacert(alias, password.toCharArray(), leidos);
